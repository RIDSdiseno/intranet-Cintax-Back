...
const TAREAS_CONTA_BASE: TareaContaBase[] = [
  {
    area: Area.CONTA,
  ...
  },
  {
    ...
    detalle: "Conciliar",
    frecuencia: FrecuenciaTarea.SEMANAL,
  ...
  },
  {
    ...
    detalle:
      "Informe con pantallazos con cuotas por vencer de convenios y/o postergaciones de impuestos.",
    frecuencia: FrecuenciaTarea.MENSUAL,
    frecuenciaTexto: "Mensual",
    plazoMaximoTexto: "25 de cada mes",
    presentacion: Presentacion.CLIENTE,
  ...
  },
  {
    ...
    detalle:
      "Mensual con detalle de activos años anteriores y en curso, revision interna",
    frecuencia: FrecuenciaTarea.MENSUAL,
    frecuenciaTexto: "Mensual",
    plazoMaximoTexto: "25 de cada mes / sobre el mes anterior",
    presentacion: Presentacion.INTERNO,
