// src/controllers/correoTareas.controller.ts
import { Request, Response } from "express";
import { sendEmailAsUser } from "../services/gmailDelegated.service";
import type { AuthRequest } from "./tareas.Controller"; // o donde tengas tu tipo

export class CorreoTareasController {
  static async enviarCorreo(req: AuthRequest, res: Response) {
    try {
      const { id } = req.params;
