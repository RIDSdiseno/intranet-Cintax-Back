...
import { createTicket, googleLoginTrabajador, listTickets, loginTrabajador, logoutTrabajador, registerTrabajador, syncTickets } from "../controllers/auth.controller";
