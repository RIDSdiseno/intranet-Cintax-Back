...
const clientesJaime: ClienteInput[] = [
  {
    rut: "77.254.393-K",
  ...
  },
  {
    rut: "76.134.386-6",
    razonSocial:
      "EDUARDO MONTES DE OCA PUBLICIDAD Y COMUNICACIONES E.I.R.L.",
    alias: "Holding Meathouse",
  },
  {
    rut: "76.788.299-8",
  ...
  },
  {
    rut: "77.952.575-9",
    razonSocial:
      "INVERSIONES E INMOBILIARIA FREDDY ALCARAZ CABEZAS SPA",
    alias: "Holding Falc",
  },
  {
    rut: "78.070.774-7",
  ...
  },
  {
    rut: "76.281.127-8",
    razonSocial:
      "IMPORTADORA Y COMERCIALIZADORA FIRSTPACK SPA",
    alias: "Holding Hassi",
  },
  {
    rut: "77.618.912-K",
    razonSocial:
      "IMPORTADORA Y COMERCIALIZADORA TALPACK SPA",
    alias: "Holding Hassi",
  },
  {
    rut: "76.902.138-8",
    razonSocial:
      "IMPORTADORA Y COMERCIALIZADORA ALQUIPACK SPA",
    alias: "Holding Hassi",
  },
  {
    rut: "76.190.132-K",
  ...
  },
  {
    rut: "78.014.384-3",
    razonSocial:
      "IMPORTADORA Y COMERCIALIZADORA PREGIATA SPA",
    alias: "Holding Hassi",
  },
  {
    rut: "78.003.922-1",
    razonSocial:
      "IMPORTADORA Y COMERCIALIZADORA PUERTOPACK SPA",
    alias: "Holding Hassi",
  },
  {
    rut: "77.956.388-K",
