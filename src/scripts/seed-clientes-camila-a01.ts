...
const clientesCamila: {
  ...
  },
  {
    rut: "76.366.844-4",
    razonSocial:
      "AVENDANO COMERCIALIZADORA Y CONSULTORA DE PRODUCTOS LIMITADA",
  },
  // Holding BRAS
  {
    rut: "76.274.504-6",
  ...
  // Holding Sandra
  {
    rut: "77.675.520-6",
    razonSocial:
      "SOCIEDAD EDUCACIONAL Y DE CAPACITACION RODRIGUEZ CORNEJO SPA",
  ...
  },
  {
    rut: "76.086.091-3",
    razonSocial:
      "SAN SALVADOR LTDA SOCIEDAD EDUCACIONALl E INMOBILIARIA",
    alias: "Holding Sandra",
  },
  {
    rut: "76.558.624-0",
    razonSocial:
      "SOCIEDAD EDUCACIONAL E INMOBILIARIA SAN FERMIN LTDA",
    alias: "Holding Sandra",
  },
  {
    rut: "76.430.373-3",
  ...
  },
  {
    rut: "77.990.400-8",
    razonSocial:
      "SOCIEDAD EDUCACIONAL E INMOBILIARIA SAN IGNACIO LTDA",
    alias: "Holding Sandra",
  },
  {
    rut: "76.620.801-0",
  ...
  },
  {
    rut: "76.439.921-8",
    razonSocial:
      "COMERCIALIZADORA Y ELABORADORA DILICI LIMITADA",
  },
  // Holding GV
  {
    rut: "78.991.080-4",
  ...
  },
  {
    rut: "77.092.057-4",
    razonSocial:
      "EMPRESA DE FABRICACIÓN E IMPORTACIÓN DE AISLANTES TÉRMICOS SPA",
    alias: "Holding Aislacel",
  },
  // Holding Prored
  {
    rut: "76.681.721-1",
    razonSocial:
      "SERVICIOS Y PROYECTOS DE TECNOLOGIA PRORED ZONA NORTE LIMITADA",
    alias: "Holding Prored",
  },
  {
    rut: "76.315.244-8",
    razonSocial:
      "ASESO. EN TECNOLOGÍAS DE LA INFO. JORGE PATRICIO HENRÍQUEZ JARA, E.I.R.L.",
    alias: "Holding Prored",
  },
  // Holding Pinto
  {
