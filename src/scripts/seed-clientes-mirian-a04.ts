...
const clientesMirian: ClienteInput[] = [
  ...
  },
  {
    rut: "76.014.262-K",
    razonSocial:
      "EELAW Medio Ambiente y Energia Asesorias Legales Limitada",
  },
  // Holding CHM
  {
    rut: "76.214.406-9",
  ...
  },
  {
    rut: "76.327.846-8",
    razonSocial:
      "SOCIEDAD DISENO Y FABRICACION MUEBLES OFICINA Y CONSTRUCCION MILENIO O",
  },
  {
    rut: "76.489.793-5",
...
async function main() {
  if (!MIRIAN_TRABAJADOR_ID) {
    console.error(
      "❌ Debes configurar MIRIAN_TRABAJADOR_ID con el id_trabajador real de Mirian."
    );
    process.exit(1);
  }
