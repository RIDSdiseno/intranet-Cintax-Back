...
const clientesDiego: {
  ...
  // Holding Aquiles
  {
    rut: "76.510.966-3",
    razonSocial:
      "AQUILES JULIO REVELLO CAVADA SERVICIOS DE INGENIERIA E.I.R.L.",
  ...
  // Holding SMI
  {
    rut: "77.572.652-0",
    razonSocial:
      "SERVICIOS MEDICOS INTEGRALES UTM ARICA NORTE SPA",
    alias: "Holding SMI",
  },
  {
    rut: "77.572.655-5",
    razonSocial:
      "SERVICIOS MEDICOS INTEGRALES UTM PUNTA ARENAS PIONEROS SPA",
    alias: "Holding SMI",
  },
  {
    rut: "77.572.657-1",
    razonSocial:
      "SERVICIOS MEDICOS INTEGRALES UTM QUILPUE BELLOTO SPA",
    alias: "Holding SMI",
  },
  {
    rut: "77.470.211-3",
