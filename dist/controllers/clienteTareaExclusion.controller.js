...
exports.reactivarTareaParaCliente = exports.excluirTareaParaCliente = exports.listExclusionesTareaCliente = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
/**
 * GET /api/clientes/:rut/exclusiones-tareas
 */
const listExclusionesTareaCliente = async (req, res) => {
    try {
        const rut = String(req.params.rut || "").trim();
        if (!rut)
            return res.status(400).json({ error: "Falta rut" });
...
exports.listExclusionesTareaCliente = listExclusionesTareaCliente;
/**
 ...
 */
const excluirTareaParaCliente = async (req, res) => {
    try {
        const rut = String(req.params.rut || "").trim();
        const { tareaPlantillaId, motivo, cancelarPendientes } = req.body;
        if (!rut)
            return res.status(400).json({ error: "Falta rut" });
...
exports.excluirTareaParaCliente = excluirTareaParaCliente;
/**
 ...
 */
const reactivarTareaParaCliente = async (req, res) => {
    try {
        const rut = String(req.params.rut || "").trim();
