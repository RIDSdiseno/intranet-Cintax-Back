...
exports.syncTicketsFromFreshdesk = syncTicketsFromFreshdesk;
...
const freshdeskClient = axios_1.default.create({
...
async function fetchFreshdeskTicketsPage(page, perPage = 100) {
 ...
 */
function mapFreshdeskTicketToPrisma(ticket, groupsMap) {
 ...
 */
async function syncTicketsFromFreshdesk(perPage = 100) {
